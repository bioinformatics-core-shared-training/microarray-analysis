...
(from my [thesis](https://www.repository.cam.ac.uk/handle/1810/218542) in 2007)
...
array. In the earliest microarrayseach feature on
...
For instance, different length probe sequences (usually measured in the number of base-pairs) can be used as well as mRNA or cDNA probes, rather than
