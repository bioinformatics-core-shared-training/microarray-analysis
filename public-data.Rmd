...
## Example. Dealing with large cohorts
...
```{r}
par(mfrow=c(2,4))
boxplot(subset[1,]~pd$characteristics_ch1.1,las=2)
boxplot(subset[2,]~pd$characteristics_ch1.1,las=2)
boxplot(subset[3,]~pd$characteristics_ch1.1,las=2)
boxplot(subset[4,]~pd$characteristics_ch1.1,las=2)
boxplot(subset[5,]~pd$characteristics_ch1.1,las=2)
boxplot(subset[6,]~pd$characteristics_ch1.1,las=2)
boxplot(subset[7,]~pd$characteristics_ch1.1,las=2)
boxplot(subset[8,]~pd$characteristics_ch1.1,las=2)
```
...
mydata <- getAE("E-GEOD-69017",type="processed")
mydata
```
