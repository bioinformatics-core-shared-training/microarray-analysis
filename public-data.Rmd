...
******
### Now create a new dataset with the poor quality arrays removed
...
# GEO Example. Dealing with large cohorts
...
```{r}
par(mfrow=c(2,4))
boxplot(subset[1,]~gender,las=2)
boxplot(subset[2,]~gender,las=2)
boxplot(subset[3,]~gender,las=2)
boxplot(subset[4,]~gender,las=2)
boxplot(subset[5,]~gender,las=2)
boxplot(subset[6,]~gender,las=2)
boxplot(subset[7,]~gender,las=2)
boxplot(subset[8,]~gender,las=2)
```
