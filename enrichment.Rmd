...
strict the dataset to only probes for which we have a Entrez ID. 
...
After this filtering, we are left with 

It is also recommended to select probes with sufficient variability across samples to be interesting; as probes with little variability will no be interesting to the question we are trying to answer. The IQR of each probe across all arrays is commonly used for this with a cut-off of 0.25.
