...
```{r}
dend.euclid <- as.dendrogram(clust.euclid)
dend.cor <- as.dendrogram(clust.cor)
plot(dend.euclid,horiz=TRUE,label=SampleGroup)
plot(dend.cor,horiz=TRUE,label=SampleGroup)
```
...
colourMatrix[,1] <- as.character(labs)
